...
function CountryInfoPage({ country }) {
  ...
  return (
    <div className="w-full bg-gray-100 p-4 sm:p-6 md:p-11">
      <div className="mb-8 max-w-2xl mx-auto px-4">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2 text-left">
          Country Information
        </h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-12 max-w-5xl mx-auto">
        {/* العلم */}
        <motion.div
        ...
        >
          <img
            ...
            alt="Flag"
            className="w-20 h-20 object-contain mb-2 max-w-full"
          />
