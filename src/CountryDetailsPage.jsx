...
function CountryDetailsPage({ country }) {
  ...
  return (
    <div
      className="w-full min-h-[400px] bg-cover bg-no-repeat bg-center text-white p-8 md:p-16"
      style={{
        backgroundImage:
          "url('https://img.freepik.com/premium-photo/dark-room-with-light-ceiling_670382-13125.jpg')",
      }}
    >
      {/* العنوان */}
